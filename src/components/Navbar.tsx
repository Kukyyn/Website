...
import { Menu, X, Map, Coins, LogIn, LogOut, User } from 'lucide-react';
              ...
              {user ? (
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-2 bg-stone-800 border border-stone-700 rounded px-3 py-1.5">
                    ...
                    <span className="text-xs text-stone-300 font-medium max-w-[100px] truncate">{userLabel}</span>
                  </div>
                  <button
                    onClick={signOut}
                ...
                {user ? (
                  <>
                    <div className="flex items-center gap-2 bg-stone-800 border border-stone-700 rounded px-3 py-2">
                      <User size={13} className="text-forest-400" />
                      <span className="text-xs text-stone-300 truncate">{userLabel}</span>
                    </div>
                    <button
